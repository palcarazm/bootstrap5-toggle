...
<script>
  document.getElementById("api-option-form").onsubmit = (e) => {
    ...
    document.getElementById("api-option-toggle").bootstrapToggle({
      ...
      tooltip: {
        placement: "top",
        title: { on: "Enabled", off: "Disabled", mixed: "Mixed" },
      },
    });
  };
</script>`;
    ...
    <table class="table table-striped table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  <table class="table table-striped table-condensed">
                    <caption>Tooltip options</caption>
                    <thead>
                      <tr>
                        <th>Name</th>
                        <th>Type</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>string</td>
                        <td><code>"top"</code></td>
                        <td>Placement of the tooltip. Possible values are: <code>top</code>, <code>bottom</code>, <code>left</code>, and <code>right</code>.</td>
                      </tr>
                      <tr>
                        <td><code>title.on</code></td>
                        <td>string | html</td>
                        <td><code>undefined</code></td>
                        <td>Title of the tooltip when the toggle is on.</td>
                      </tr>
                      <tr>
                        <td><code>title.off</code></td>
                        <td>string | html</td>
                        <td><code>undefined</code></td>
                        <td>Title of the tooltip when the toggle is off.</td>
                      </tr>
                      <tr>
                        <td><code>title.mixed</code></td>
                        <td>string | html</td>
                        <td><code>undefined</code></td>
                        <td>Title of the tooltip when the toggle is in mixed state (if tristate is enabled).</td>
                      </tr>
                    </tbody>
                  </table>
                </td>
