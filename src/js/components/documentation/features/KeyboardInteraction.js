...
class KeyboardInteraction {
  static build() {
    ...
    description.innerHTML = `Bootstrap toggle supports keyboard interaction. Toggle can be switched pressing <code>SPACEBAR</code> while it's focused and support <code>TAB</code> navigation.
