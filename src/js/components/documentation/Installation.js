...
class Installation extends DocSection {
  ...
  static #cdn() {
    const ecmas = `<link href="https://cdn.jsdelivr.net/npm/bootstrap5-toggle@5.2.0-rc1/css/bootstrap5-toggle.min.css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/npm/bootstrap5-toggle@5.2.0-rc1/js/bootstrap5-toggle.ecmas.min.js"></script>`;
    const jquery = `<link href="https://cdn.jsdelivr.net/npm/bootstrap5-toggle@5.2.0-rc1/css/bootstrap5-toggle.min.css" rel="stylesheet">
