...
[![Security](https://img.shields.io/snyk/vulnerabilities/npm/bootstrap5-toggle@5.1.3?logo=snyk)](https://snyk.io/advisor/npm-package/bootstrap5-toggle)
...
```html
<link
  href="https://cdn.jsdelivr.net/npm/bootstrap5-toggle@5.1.3/css/bootstrap5-toggle.min.css"
  rel="stylesheet" />
<script src="https://cdn.jsdelivr.net/npm/bootstrap5-toggle@5.1.3/js/bootstrap5-toggle.ecmas.min.js"></script>
```
...
<link
  href="https://cdn.jsdelivr.net/npm/bootstrap5-toggle@5.1.3/css/bootstrap5-toggle.min.css"
  rel="stylesheet" />
<script src="https://cdn.jsdelivr.net/npm/bootstrap5-toggle@5.1.3/js/bootstrap5-toggle.jquery.min.js"></script>
```
...
```ksh
npm install bootstrap5-toggle@5.1.3
```

## Yarn

```ksh
yarn add bootstrap5-toggle@5.1.3
```
