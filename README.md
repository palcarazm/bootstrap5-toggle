...
```html
<link
  href="https://cdn.jsdelivr.net/npm/bootstrap5-toggle@5.3.0-rc1/css/bootstrap5-toggle.min.css"
  rel="stylesheet" />
<script src="https://cdn.jsdelivr.net/npm/bootstrap5-toggle@5.3.0-rc1/js/bootstrap5-toggle.ecmas.min.js"></script>
```
...
<link
  href="https://cdn.jsdelivr.net/npm/bootstrap5-toggle@5.3.0-rc1/css/bootstrap5-toggle.min.css"
  rel="stylesheet" />
<script src="https://cdn.jsdelivr.net/npm/bootstrap5-toggle@5.3.0-rc1/js/bootstrap5-toggle.jquery.min.js"></script>
```
...
```ksh
npm install bootstrap5-toggle@5.3.0-rc1
```

## Yarn

```ksh
yarn add bootstrap5-toggle@5.3.0-rc1
```
